...
//       console.log(isGradeA(grades[2])); // t
...
console.log(filterAdult(peoples));
...
console.log(filter(peoples, isAdult));
...
function multiplyBy(num) {
    return function multiplyByFive(num2) {
        return num * num2;
    }
}
let multiplyByFive = multiplyBy(5);
